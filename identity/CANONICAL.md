...
- **Authority chain:** koad → Juno → sibyl
- **Cryptographic identity:** Keys in ~/.sibyl/id/
- **Located at:** $HOME = ~/.sibyl
- **Repository:** koad/sibyl (GitHub)
